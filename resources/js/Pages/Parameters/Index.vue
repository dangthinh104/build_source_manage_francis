  ...
  <AuthenticatedLayout>
    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <button @click="openCreate" class="inline-flex items-center gap-2 px-5 py-2.5 btn-primary text-white rounded-xl font-semibold shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5">
      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden max-w-full">
        ...
        <div class="block md:hidden divide-y divide-slate-100">
          ...
          <div v-if="parameters.length === 0" class="p-8 text-center">
            ...
            <p class="text-sm text-slate-500">No parameters found</p>
          </div>
        </div>
